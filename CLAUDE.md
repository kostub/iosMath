...
For a detailed mapping of TeX's Appendix G math typesetting algorithm onto iosMath's pipeline (rule-by-rule implementation status, font-parameter correspondence, known gaps, and an audit checklist), see [ALGORITHM.md](ALGORITHM.md).
